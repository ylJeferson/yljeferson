    ...
    public partial class frmCentroCusto : Form
    {
        ...
        private void tsbGravar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Global.Comando = new MySqlCommand("INSERT INTO centro_custo (Descricao) VALUES (?Descricao)", Global.Conexao);
                }
        ...
        {
            Global.ConsultarCentroCusto(tsTxtBusca.Text);
        ...
        {
            int posicao, itens = 0;
            string relatorio = "Centros De Custo";
            ...
            e.Graphics.DrawString("Total de centros:", new Font("Arial", 11, FontStyle.Bold), Brushes.Black, 105, 1115);
