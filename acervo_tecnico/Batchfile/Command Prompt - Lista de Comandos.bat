...
echo Command 05: %~n0
echo "Retorna o nome do arquivo (sem a extensฦo)"
echo.

echo Command 06: %~x0
echo "Retorna a extensฦo do arquivo"
echo.
...
echo "Retorna o caminho do diretขrio para o aplicativo atual .exe, finalizado com uma barra invertida … direita (global)"
echo.

echo Command 56: %__CD__%
echo "Retorna o diretขrio atual, finalizado com uma barra invertida … direita (global)"
echo.

echo Command 57: %=C:%
echo "Retorna o O diretขrio atual da unidade C:"
echo.

echo Command 58: %=D:%
echo "Retorna o diretขrio atual da unidade D: se a unidade D: foi acessada na sessฦo CMD atual"
echo.
...
echo "Retorna o cขdigo de saกda mais recente retornado por um comando externo, como CMD /C EXIT n, convertido em hexadecimal"
echo.

echo Command 61: %=ExitCodeAscii%
echo "Retorna o cขdigo de saกda mais recente retornado por um comando externo, como ASCII (os valores de 0 a 32 nฦo sฦo exibidos porque mapeiam para cขdigos de controle ASCII)"
echo.

echo Command 62: %FIRMWARE_TYPE%
echo "Retorna o tipo de inicializaฦo do sistema: Legacy, UEFI, Nฦo implementado, Desconhecido Windows 8/2012"
echo.
